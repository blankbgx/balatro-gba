"""Append Merry Andy to gfx0 slot 35 (extend 1120->1152). Zero new colors (all exact)."""
from PIL import Image

SRC = "graphics/merryandy_dl/Merry Andy.png"
DST = "graphics/joker_gfx0.png"
BAK = "graphics/joker_gfx0.pre_merryandy.png"
