"""Append Mr. Bones to gfx18 slot 2 (extend 64->96). Zero new colors needed."""
from PIL import Image

SRC = "graphics/mrbones_dl/MrBones.png"
DST = "graphics/joker_gfx18.png"
BAK = "graphics/joker_gfx18.pre_mrbones.png"
...
if len(palette) + len(new_colors) > 16:
    print(f"FATAL: palette would exceed 16")
    raise SystemExit(1)
